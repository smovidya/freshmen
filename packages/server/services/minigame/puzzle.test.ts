...
describe("scoreForAccuracy", () => {
  test("uses stable reward boundaries", () => {
    expect(scoreForAccuracy(100)).toBe(10_000);
    expect(scoreForAccuracy(90)).toBe(5_000);
    expect(scoreForAccuracy(70)).toBe(3_000);
    expect(scoreForAccuracy(50)).toBe(1_000);
