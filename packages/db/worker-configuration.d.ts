/* eslint-disable */
// Hand-maintained (not `wrangler types`): this package only needs the D1 binding it
// actually consumes, plus the `cloudflare:workers` ambient module / runtime types
// below. Don't regenerate this from apps/api/wrangler.jsonc — that pulls in unrelated
// bindings whose type-only imports (e.g. GAME_REGION_HANDLER -> apps/api/src/index.ts)
// drag that whole Worker's source into this package's compile scope.
